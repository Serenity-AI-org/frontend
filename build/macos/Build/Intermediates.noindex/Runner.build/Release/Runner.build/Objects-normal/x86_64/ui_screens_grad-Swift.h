...
#ifndef UI_SCREENS_GRAD_SWIFT_H
#define UI_SCREENS_GRAD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ui_screens_grad",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15ui_screens_grad11AppDelegate")
...
SWIFT_CLASS("_TtC15ui_screens_grad17MainFlutterWindow")
